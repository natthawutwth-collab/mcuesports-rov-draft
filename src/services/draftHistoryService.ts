...
// Singleton repository instance (can easily be swapped with Firebase/Supabase implementation in future)
export const draftRepository: DraftRepository = new LocalStorageDraftRepository();
